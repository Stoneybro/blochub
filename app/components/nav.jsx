...
const Nav = () => {
  ...
  return (
    <nav className=' sticky top-0 w-full bg-primary  h-[82px] z-10 pb-4  '>
      ...
      <div className="flex  items-center mx-auto max-w-[1130px] relative">
     ...
     {toggle&& <div className="bg-white h-screen w-screen fixed overflow-hidden top-0 pointer-events-none left-0 "></div>}
