  ...
  return (
    <div className=" text-white py-[22px] fixed w-full top-0 z-40 mix-blend-difference">
        <div className="w-[1110px] mx-auto flex items-center">
            ...
            <div className=" flex-1 flex justify-end"><button className="border rounded-full px-6 py-[0.3rem] border-white text-white mix-blend-difference inline font-light">REGISTER</button></div>
        </div>
    </div>
  )
}
